          ...
          <div style={{ background: 'white', borderRadius: '12px', boxShadow: '0 14px 35px rgba(10,19,45,.10)', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ padding: '32px 28px', flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              <p style={{ margin: '0 0 20px', color: '#4A4A4A', fontSize: '.92rem', lineHeight: 1.5 }}>
                Accede con correo y contraseña o con ClaveÚnica. Funcionario: <strong>admin@municipio.cl</strong> / <strong>admin123</strong>.
              </p>
            </div>
          </div>
              ...
              {activeTab === 'correo' && (
                <div>
                  ...
                  <div style={{ marginBottom: '14px' }}>
                    ...
                    <IonItem lines="full" style={{ '--background': 'white', '--border-color': passwordTouched && password.trim().length === 0 ? '#FE6565' : '#cbd5e1', '--border-radius': '4px' }}>
                      <IonInput
                        type="password"
              ...
              {activeTab === 'claveunica' && (
                <div style={{ textAlign: 'center', padding: '12px 0' }}>
                  ...
                  <IonButton
                    expand="block"
                    onClick={async () => {
                      await authService.loginClaveUnica();
