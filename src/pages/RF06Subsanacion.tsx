...
import { 
  ...
  logOutOutline, warningOutline, downloadOutline
} from 'ionicons/icons';
    ...
    <IonPage>
      <IonHeader>
        <IonToolbar style={{ '--background': '#006FB3', '--color': 'white' }}>
          <IonTitle>Subsanar Observación</IonTitle>
          <IonButtons slot="end">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: '16px', marginBottom: '16px', alignItems: 'start' }}>
            ...
            <div style={{ background: 'white', borderRadius: '10px', boxShadow: '0 6px 18px rgba(10,19,45,.08)', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '16px' }}>
                ...
                <p style={{ margin: '0 0 6px', fontSize: '.86rem', color: '#4A4A4A' }}><strong>Ticket:</strong> SD-2026-041</p>
                <p style={{ margin: '0 0 6px', fontSize: '.86rem', color: '#4A4A4A' }}><strong>Fecha de observación:</strong> 07/05/2026</p>
                <p style={{ margin: 0, fontSize: '.86rem', color: '#4A4A4A' }}><strong>Plazo restante:</strong> 8 días hábiles para corregir.</p>
              </div>
            </div>
            ...
            <div style={{
              ...
              <strong style={{ display: 'block', fontSize: '1.8rem', color: '#0A132D', fontWeight: 700, lineHeight: 1.1 }}>8</strong>
