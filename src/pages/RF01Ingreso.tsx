import { 
  ...
  IonTabBar, IonTabButton, IonInput, useIonRouter
} from '@ionic/react';
import { 
  addCircleOutline, 
  listOutline, 
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '20px', maxWidth: '1100px', margin: '0 auto', padding: '24px 16px' }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{
              ...
              <p style={{ margin: '0 0 4px', fontSize: '.82rem', color: '#4A4A4A' }}>
                Ticket asignado automáticamente
              </p>

              <strong style={{ display: 'block', fontSize: '1.5rem', color: '#0A132D', fontWeight: 700 }}>
                SD-2026-001
              </strong>

              <span style={{ fontSize: '.82rem', color: '#4A4A4A' }}>
                Guarda este número para trazabilidad.
              </span>
            </div>
