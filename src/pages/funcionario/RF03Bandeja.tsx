...
const RF03Bandeja: React.FC = () => {
  ...
  useIonViewWillEnter(() => {
    setTramites(tramitesService.getAll());
  });
    ...
    <IonPage>
      ...
      <IonFooter className="ion-no-border">
        <IonTabBar slot="bottom" style={{ borderTop: '1px solid #ddd' }}>
          ...
          <IonTabButton tab="alertas" routerLink="/funcionario/alertas"><IonIcon icon={alertCircleOutline} /><IonLabel>Alertas</IonLabel></IonTabButton>
